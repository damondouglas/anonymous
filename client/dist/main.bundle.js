...
module.exports = "<h1>Anonymous Notes</h1>\n<form (submit)=submit()>\n  <div class=\"form-container\">\n    <label for=\"note\">Note:</label>\n    <input \n      type=\"text\" \n      name=\"note\" \n      required\n      minlength=\"3\"\n      (input)=input() \n      [(ngModel)]=\"content\"\n      #note=\"ngModel\"\n    >\n    <input type=\"submit\" value=\"Add Note\" [disabled]=\"disableSubmit\">\n  </div>\n</form>\n\n<div>\n  <app-notelist [notes]=notes></app-notelist>\n</div>"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.input = function () {
        this.disableSubmit =
    ...
    AppComponent.prototype.submit = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.create(this.content)];
                    case 1:
                        _a.sent();
                        this.refreshNotes();
                        return [2 /*return*/];
    ...
    AppComponent.prototype.refreshNotes = function () {
        var _this = this;
        var compare = function (note1, note2) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__notelist_notelist_component__ = __webpack_require__("./src/app/notelist/notelist.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__note_service__ = __webpack_require__("./src/app/note.service.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__notelist_notelist_component__["a" /* NotelistComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_6__note_service__["a" /* NoteService */]],
...
// module
exports.push([module.i, ".note, .container {\n    border: solid 1px black;\n}\n\n.container {\n    position: absolute;\n    overflow-y: scroll;\n    margin-top: 50px;\n    bottom: 50px;\n    right: 20px;\n    left: 20px;\n    top: 100px;\n}\n\n.note {\n    margin: 10px;\n    position: relative;\n}\n\n.header {\n    position: absolute;\n    right: 10px;\n    top: 10px;\n}\n\n.content {\n    margin-top: 40px;\n    text-align: left;\n}", ""]);
...
module.exports = "<div class=\"container\">\n  <div *ngFor=\"let note of notes\">\n    <div class=\"note\">\n      <div class=\"header\">\n        <div class=\"timestamp\">Note on {{note.createdAt | date:'medium'}}</div>\n      </div>\n      <div class=\"content\">{{note.content}}</div>\n    </div>\n  </div>\n</div>"
...
var NotelistComponent = (function () {
    function NotelistComponent(service) {
        this.service = service;
        this.notes = [];
    }
